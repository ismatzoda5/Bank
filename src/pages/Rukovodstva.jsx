...
const Rukovodstva = () => {
  const data = [
    ...
    return (
      <div className="pl-[100px] pr-[100px] pt-[30px] pb-[30px] dark:bg-gray-800 dark:text-[white]">
        <h1 className="text-[30px] font-[600] text-[#EBA707]">
          Наща Руководство
        </h1>
        <div className="flex justify-between items-center flex-wrap  gap-[30px] mt-[20px] ">
          {data.map((elem) => {
            return (
              <div
                key={elem.id}
                className="elem w-[30%] h-[60vh] p-[10px] border-[1px] rounded-md hover:border-[#EBA707]"
              >
                <img
                  ...
                  alt=""
                />
                <h1 className="text-[28px] text-center font-[500] pt-[5px] hover:text-[#EBA707]">
                  {elem.fullname}
                </h1>
                <h1 className="role text-[18px] text-[#EBA707]  text-center pt-[5px]">
                  {elem.role}
                </h1>
              </div>
            );
